...
values."
  (setq-default
   ...
   dotspacemacs-configuration-layer-path '("~/spc-layers")
...
`dotspacemacs/user-config' first."
  (setq spacemacs-boon-leader-key "ä")
  (setq spacemacs-boon-major-mode-leader-key "#")
...
you should place your code here."
  ...
  (define-key ivy-minibuffer-map (kbd "M-o") 'ivy-next-line)
  (elscreen-start)
  )
